...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yeying/api/rag/knowledge_pb2_grpc.py depends on'
...
def add_KnowledgeServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yeying.api.rag.Knowledge', rpc_method_handlers)
